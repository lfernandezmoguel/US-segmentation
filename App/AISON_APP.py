...
# In this section of the code would be posible to implement the models, for the demo version there are disabled and not included in the repo but the placeholder was left in the code below:
elif app_mode == "Prediction mode": # Here would be posible to use different models
    st.header('Prediction Mode')
#    st.subheader(calculation_mode + " prediction with " + model_type + " model")
    st.subheader(" NOT AVAILABLE IN DEMO VERSION")
